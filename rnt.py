...
for i in range(7):
    ...
    gas.set_multiplier(M_final, i)
    print(f"Applied M={M_final:.3g}")

print("Electron energy levels:")
print(gas.electron_energy_levels)
...
print("Simulation complete. Elapsed time: {:.3f} s".format(time.time() - SZ_start_time))
# Plotting
