...
import CombUtils
from hy3reactors import run_psr_constP
...
def neutral_HP_to_plasma_IC(phi, fuel_str, oxid_str, h_after, T0, P0, mech_plasma, mech_neutral='nDodecane_ReitzNO.yaml'):
    ...
    elec = 'e' if 'e' in g0.species_names else ('Electron' if 'Electron' in g0.species_names else None)
    if elec:
        X_map[elec] = X_map.get(elec, 0.0) + 1e-11
    else:
        print("[note] electron species not found in plasma mech; skipped adding e:1e-11")
